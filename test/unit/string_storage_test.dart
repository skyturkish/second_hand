...
void main() {
  group('from Storage download url to Storage reference', () {
    test('basic ', () {
      ...
      // first part
      final index = downloadUrl.indexOf('/o/');
      if (index >= 0) {
      ...
      // last part
      final index2 = downloadUrl.indexOf('?alt=media');
      if (index2 >= 0) {
    ...
    test('more clear thanks to bstech', () {
      var downloadUrl =
          'https://firebasestorage.googleapis.com/v0/b/second-hand-sky.appspot.com/o/products%2F2b1ab929-4914-4d1e-b133-9a2eae8143d8?alt=media&token=db1c975c-18d2-4dd7-bf4f-d3fe9eef7da1';

      final ps = downloadUrl.lastIndexOf('/') + 1;
      var qs = downloadUrl.indexOf('?', ps);
